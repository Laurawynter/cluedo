...
" Kitchen","Study","Library","Billiard Room", "Lounge", "Ballroom",
 "Hall", "Spa",
...
// Crea el misterio//
   ...
   return [character, weapon, room];
    ...
    const characters=(misteryArray)[0]
    const weapon =(misteryArray)[1]
    const room =(misteryArray)[2]
    }
